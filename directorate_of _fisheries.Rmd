...
df1 <- data.matrix(bot_jul_des[,1:5])
rownames(df1) <- rownames(bot_jul_des)
...
pheatmap(values(tail(df2,20),norm='p'),colfunc(10), cluster_rows = FALSE, cluster_cols = FALSE)
...
multiple_Hutcheson_t_test(df2,  shannon.base = exp(1))
```
